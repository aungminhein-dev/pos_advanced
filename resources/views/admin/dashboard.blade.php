                        ...
                        <ul class="list-unstyled list-unstyled-border">
                            <li class="media">
                                <img class="mr-3 rounded" width="55"
                                    src="{{ asset('admin/dist/assets/img/products/product-3-50.png') }}" alt="product">
                            ...
                            <li class="media">
                                <img class="mr-3 rounded" width="55"
                                    src="{{ asset('admin/dist/assets/img/products/product-4-50.png') }}" alt="product">
                                <div class="media-body">
                                    <div class="float-right">
                            ...
                            <li class="media">
                                <img class="mr-3 rounded" width="55"
                                    src="{{ asset('admin/dist/assets/img/products/product-1-50.png') }}" alt="product">
                                <div class="media-body">
                                    <div class="float-right">
                            ...
                            <li class="media">
                                <img class="mr-3 rounded" width="55"
                                    src="{{ asset('admin/dist/assets/img/products/product-5-50.png') }}" alt="product">
                                <div class="media-body">
                                    <div class="float-right">
