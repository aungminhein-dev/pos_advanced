...
@section('title', 'Add Delivery Location')
@section('content')
        ...
        <div class="section-body">
            <div class="row">
                ...
                <div class="card shadow p-3 col-lg-8  d-flex justify-center">
                        <form action="{{ route('delivery-location.add') }}" method="post">
                            @csrf
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <select name="gateFeeStatus" id="" class="form-control">
                                            ...
                                            <option value="0">Have to pay</option>
                                            <option value="1">Don't have to pay</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group mt-2">
                                ...
                                <input type="number" name="gateFee" class="form-control" id="">
                            </div>
