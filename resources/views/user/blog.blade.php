                        ...
                        <div class="row">
                                ...
                                <article class="first-post mb-30 wow fadeIn animated hover-up">
                                    ...
                                    <div class="entry-content">
                                        <div class="entry-meta meta-1 mb-30">
                                            <a class="entry-meta meta-0" href="blog.html"><span
                                        ...
                                        <h2 class="post-title mb-20">
                                            <a href="blog-details.html">Barcelona: marathan; south korean pulls away for a
                                                grueling surprise</a>
                                        </h2>
                                        <p class="post-exerpt font-medium text-muted mb-30">These people envy me for having
                                            a lifestyle they don’t have, but the truth is, sometimes I envy their lifestyle
                                            instead. Struggling to sell one multi-million dollar home currently.</p>
                                        <div class="mb-20 entry-meta meta-2">
                                            ...
                                            <a href="blog-details.html" class="btn btn-sm">Read more<i
                            ...
                            <div class="col-lg-6">
                                <article class="wow fadeIn animated hover-up mb-30">
                                    <div class="post-thumb img-hover-scale">
                                        <a href="blog-details.html">
                                            <img src="{{ asset('user/assets/imgs/blog/blog-2.jpg') }}" alt="">
                                        </a>
                                    ...
                                    <div class="entry-content-2">
                                        <h3 class="post-title mb-15">
                                            <a href="blog-details.html">The litigants on the screen are not actors</a>
                                        </h3>
                                        <p class="post-exerpt mb-30">These people envy me for having a lifestyle they don’t
                                            have, but the truth is, sometimes I envy their lifestyle instead. Struggling to
                                            sell one multi.</p>
                                        <div class="entry-meta meta-1 font-xs color-grey mt-10 pb-10">
                                            ...
                                            <a href="blog-details.html" class="text-brand">Read more <i
                            ...
                            <div class="col-lg-6">
                                <article class="wow fadeIn animated hover-up mb-30">
                                    <div class="post-thumb img-hover-scale">
                                        <a href="blog-details.html">
                                            <img src="{{ asset('user/assets/imgs/blog/blog-8.jpg') }}" alt="">
                                        </a>
                                        <div class="entry-meta">
                                    ...
                                    <div class="entry-content-2">
                                        <h3 class="post-title mb-15">
                                            <a href="blog-details.html">Essential Qualities of Highly Successful Music</a>
                                        </h3>
                                        <p class="post-exerpt mb-30">Graduating from a top accelerator or incubator can be
                                            as career-defining for a startup founder as an elite university diploma. The
                                            intensive programmes, which</p>
                                        <div class="entry-meta meta-1 font-xs color-grey mt-10 pb-10">
                                            <div>
                                                <span class="post-on"> <i class="fi-rs-clock"></i> 25 April 2022</span>
                                                <span class="hit-count has-dot">126k Views</span>
                            ...
                            <div class="col-lg-6">
                                <article class="wow fadeIn animated hover-up mb-30">
                                    ...
                                    <div class="entry-content-2">
                                        <h3 class="post-title mb-15">
                                            <a href="blog-details.html">9 Things I Love About Shaving My Head</a>
                                        </h3>
                                        <p class="post-exerpt mb-30">At the Emmys, broadcast scripted shows created by
                                            people of color gained ground relative to those pitched by White show creators,
                            ...
                            <div class="col-lg-6">
                                <article class="wow fadeIn animated hover-up mb-30">
                                    ...
                                    <div class="entry-content-2">
                                        <h3 class="post-title mb-15">
                                            <a href="blog-details.html">Why Teamwork Really Makes The Dream Work</a>
                                        </h3>
                                        <p class="post-exerpt mb-30">We live in a world where disruption and dynamism reign
                                            supreme and businesses must be ready to adapt to the many unpredictable changes
                            ...
                            <div class="col-lg-6">
                                <article class="wow fadeIn animated hover-up mb-30">
                                    ...
                                    <div class="entry-content-2">
                                        <h3 class="post-title mb-15">
                                            <a href="blog-details.html">The World Caters to Average People</a>
                                        </h3>
                                        <p class="post-exerpt mb-30">These people envy me for having a lifestyle they don’t
                                            have, but the truth is, sometimes I envy their lifestyle instead. Struggling to
                                            sell oney.</p>
                            ...
                            <div class="col-lg-6">
                                <article class="wow fadeIn animated hover-up mb-30">
                                    <div class="post-thumb img-hover-scale">
                                        <a href="blog-details.html">
                                            <img src="{{ asset('user/assets/imgs/blog/blog-9.jpg') }}" alt="">
                                        </a>
                                        <div class="entry-meta">
                                            <a class="entry-meta meta-2" href="blog.html">Politic</a>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-12 sm-grid-content mb-30">
                                    ...
                                    <div class="post-content media-body">
                                        <h4 class="post-title mb-10 text-limit-2-row">The litigants on the screen are not
                                            actors </h4>
                                ...
                                <div class="col-md-6 col-sm-6 sm-grid-content mb-30">
                                    ...
                                    <div class="post-content media-body">
                                        <h6 class="post-title mb-10 text-limit-2-row">Water Partners With Rag &amp; Bone To
                                            Consume</h6>
                                        <div class="entry-meta meta-13 font-xxs color-grey">
                                            <span class="post-on mr-10">25 April</span>
                                            <span class="hit-count has-dot ">126k Views</span>
                                ...
                                <div class="col-md-6 col-sm-6 sm-grid-content mb-30">
                                    ...
                                    <div class="post-content media-body">
                                        <h6 class="post-title mb-10 text-limit-2-row">The loss is not all that surprising
                                        </h6>
                                        <div class="entry-meta meta-13 font-xxs color-grey">
                                            <span class="post-on mr-10">25 April</span>
                                            <span class="hit-count has-dot ">126k Views</span>
                                ...
                                <div class="col-md-6 col-sm-6 sm-grid-content mb-30">
                                    ...
                                    <div class="post-content media-body">
                                        <h6 class="post-title mb-10 text-limit-2-row">We got a right to pick a little
                                            fight, Bonanza </h6>
                                        <div class="entry-meta meta-13 font-xxs color-grey">
                                            <span class="post-on mr-10">25 April</span>
                                            <span class="hit-count has-dot ">126k Views</span>
