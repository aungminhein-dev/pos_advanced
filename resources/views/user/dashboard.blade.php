                        ...
                        <div class="col-md-4">
                            <div class="dashboard-menu">
                                <ul class="nav flex-column" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="logout"><i class="fi-rs-sign-out mr-10"></i>Logout</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                                    ...
                                                    <tbody>
                                                        @forelse ($orders as $order)
                                                            <tr>
                                                                ...
                                                                <td>{{ $order->total }}</td>
                                                                <td><a href="{{ route('user.orderDetails',$order->id) }}" class="btn-small d-block">View</a>
                                                                </td>
                                                            </tr>
                                                        @empty
                                                            <tr>No Orders yet!</tr>
                                            ...
                                            <form method="post" name="enq">
                                                <div class="row">
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <input required="" value="{{ Auth::user()->name }}" class="form-control square" name="name"
                                                            type="text">
                                                    </div>

                                                    <div class="form-group col-md-12">
                                                        <label>Social Media <span class="required">*</span></label>
                                                        <input required="" value="{{ Auth::user()->social_links }}" class="form-control square" name="social_link"
                                                            type="text">
                                                    </div>
                                                    <div class="form-group col-md-12">
                                                        <label>Email Address <span class="required">*</span></label>
                                                        <input required="" value="{{ Auth::user()->email }}" class="form-control square" name="email"
                                                            type="email">
                                                    </div>
                                                    <div class="form-group col-md-12">
