                                    ...
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="default-img"
                                                src="{{ asset('user/assets/imgs/shop/product-1-1.jpg') }}" alt="">
                                            <img class="hover-img"
                                                src="{{ asset('user/assets/imgs/shop/product-1-2.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    ...
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="default-img"
                                                ...
                                                alt="">
                                            <img class="hover-img"
                                                src="{{ asset('user/assets/imgs/shop/product-5-2.jpg') }}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-xs-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="default-img"
                                                src="{{ asset('user/assets/imgs/shop/product-6-1.jpg') }}"
                                                alt="">
                                            <img class="hover-img"
                                                src="{{ asset('user/assets/imgs/shop/product-6-2.jpg') }}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-xs-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="default-img"
                                                src="{{ asset('user/assets/imgs/shop/product-7-1.jpg') }}"
                                                alt="">
                                            <img class="hover-img"
                                                src="{{ asset('user/assets/imgs/shop/product-7-2.jpg') }}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="default-img"
                                                src="{{ asset('user/assets/imgs/shop/product-8-1.jpg') }}"
                                                alt="">
                                            <img class="hover-img"
                                                src="{{ asset('user/assets/imgs/shop/product-8-2.jpg') }}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="default-img"
                                                src="{{ asset('user/assets/imgs/shop/product-9-1.jpg') }}"
                                                alt="">
                                            <img class="hover-img"
                                                src="{{ asset('user/assets/imgs/shop/product-9-2.jpg') }}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="default-img"
                                                src="{{ asset('user/assets/imgs/shop/product-10-1.jpg') }}"
                                                alt="">
                                            <img class="hover-img"
                                                src="{{ asset('user/assets/imgs/shop/product-10-2.jpg') }}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="default-img"
                                                src="{{ asset('user/assets/imgs/shop/product-11-1.jpg') }}"
                                                alt="">
                                            <img class="hover-img"
                                                src="{{ asset('user/assets/imgs/shop/product-11-2.jpg') }}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="default-img"
                                                src="{{ asset('user/assets/imgs/shop/product-12-1.jpg') }}"
                                                alt="">
                                            <img class="hover-img"
                                                src="{{ asset('user/assets/imgs/shop/product-12-2.jpg') }}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="default-img"
                                                src="{{ asset('user/assets/imgs/shop/product-13-1.jpg') }}"
                                                alt="">
                                            <img class="hover-img"
                                                src="{{ asset('user/assets/imgs/shop/product-13-2.jpg') }}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="default-img"
                                                src="{{ asset('user/assets/imgs/shop/product-14-1.jpg') }}"
                                                alt="">
                                            <img class="hover-img"
                                                src="{{ asset('user/assets/imgs/shop/product-14-2.jpg') }}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="default-img"
                                                src="{{ asset('user/assets/imgs/shop/product-15-1.jpg') }}"
                                                alt="">
                                            <img class="hover-img"
                                                src="{{ asset('user/assets/imgs/shop/product-15-2.jpg') }}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="default-img"
                                                src="{{ asset('user/assets/imgs/shop/product-1-1.jpg') }}"
                                                alt="">
                                            <img class="hover-img"
                                                src="{{ asset('user/assets/imgs/shop/product-1-2.jpg') }}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                ...
                <div class="carausel-6-columns" id="carausel-6-columns">
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop.html"><img src="{{ asset('user/assets/imgs/shop/category-thumb-1.jpg') }}"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop.html"> <img src="{{ asset('user/assets/imgs/shop/category-thumb-2.jpg') }}"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop.html"><img src="{{ asset('user/assets/imgs/shop/category-thumb-3.jpg') }}"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop.html"><img src="{{ asset('user/assets/imgs/shop/category-thumb-4.jpg') }}"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop.html"><img src="{{ asset('user/assets/imgs/shop/category-thumb-5.jpg') }}"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop.html"><img src="{{ asset('user/assets/imgs/shop/category-thumb-6.jpg') }}"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop.html"><img src="{{ asset('user/assets/imgs/shop/category-thumb-7.jpg') }}"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop.html"><img src="{{ asset('user/assets/imgs/shop/category-thumb-8.jpg') }}"
                                    alt=""></a>
                        </figure>
                ...
                <div class="carausel-6-columns carausel-arrow-center" id="carausel-6-columns-2">
                    <div class="product-cart-wrap small hover-up">
                        <div class="product-img-action-wrap">
                            <div class="product-img product-img-zoom">
                                <a href="product-details.html">
                                    <img class="default-img" src="{{ asset('user/assets/imgs/shop/product-2-1.jpg') }}"
                                        alt="">
                                    <img class="hover-img" src="{{ asset('user/assets/imgs/shop/product-2-2.jpg') }}"
                                        alt="">
                                </a>
                            </div>
                            <div class="product-action-1">
                    ...
                    <div class="product-cart-wrap small hover-up">
                        <div class="product-img-action-wrap">
                            <div class="product-img product-img-zoom">
                                <a href="product-details.html">
                                    <img class="default-img" src="{{ asset('user/assets/imgs/shop/product-4-1.jpg') }}"
                                        alt="">
                                    <img class="hover-img" src="{{ asset('user/assets/imgs/shop/product-4-2.jpg') }}"
                                        alt="">
                                </a>
                            </div>
                            <div class="product-action-1">
                    ...
                    <div class="product-cart-wrap small hover-up">
                        <div class="product-img-action-wrap">
                            <div class="product-img product-img-zoom">
                                <a href="product-details.html">
                                    <img class="default-img"
                                        src="{{ asset('user/assets/imgs/shop/product-15-1.jpg') }}" alt="">
                                    <img class="hover-img" src="{{ asset('user/assets/imgs/shop/product-15-2.jpg') }}"
                                        alt="">
                                </a>
                            </div>
                            <div class="product-action-1">
                    ...
                    <div class="product-cart-wrap small hover-up">
                        <div class="product-img-action-wrap">
                            <div class="product-img product-img-zoom">
                                <a href="product-details.html">
                                    <img class="default-img" src="{{ asset('user/assets/imgs/shop/product-3-1.jpg') }}"
                                        alt="">
                                    <img class="hover-img" src="{{ asset('user/assets/imgs/shop/product-3-2.jpg') }}"
                                        alt="">
                                </a>
                            </div>
                            <div class="product-action-1">
                    ...
                    <div class="product-cart-wrap small hover-up">
                        <div class="product-img-action-wrap">
                            <div class="product-img product-img-zoom">
                                <a href="product-details.html">
                                    <img class="default-img" src="{{ asset('user/assets/imgs/shop/product-9-1.jpg') }}"
                                        alt="">
                                    <img class="hover-img" src="{{ asset('user/assets/imgs/shop/product-9-2.jpg') }}"
                                        alt="">
                                </a>
                            </div>
                            <div class="product-action-1">
                    ...
                    <div class="product-cart-wrap small hover-up">
                        <div class="product-img-action-wrap">
                            <div class="product-img product-img-zoom">
                                <a href="product-details.html">
                                    <img class="default-img" src="{{ asset('user/assets/imgs/shop/product-7-1.jpg') }}"
                                        alt="">
                                    <img class="hover-img" src="{{ asset('user/assets/imgs/shop/product-7-2.jpg') }}"
                                        alt="">
                                </a>
                            </div>
                            <div class="product-action-1">
                    ...
                    <div class="product-cart-wrap small hover-up">
                        <div class="product-img-action-wrap">
                            <div class="product-img product-img-zoom">
                                <a href="product-details.html">
                                    <img class="default-img" src="{{ asset('user/assets/imgs/shop/product-1-1.jpg') }}"
                                        alt="">
                                    <img class="hover-img" src="{{ asset('user/assets/imgs/shop/product-1-2.jpg') }}"
                                        alt="">
                                </a>
                            </div>
                            <div class="product-action-1">
            ...
            <div class="carausel-6-columns-cover position-relative wow fadeIn animated">
                ...
                <div class="carausel-6-columns text-center" id="carausel-6-columns-3">
                    <div class="brand-logo">
                        <img class="img-grey-hover" src="{{ asset('user/assets/imgs/banner/brand-1.png') }}"
                            alt="">
                    </div>
                    <div class="brand-logo">
                        <img class="img-grey-hover" src="{{ asset('user/assets/imgs/banner/brand-2.png') }}"
                            alt="">
                    </div>
                    <div class="brand-logo">
                        <img class="img-grey-hover" src="{{ asset('user/assets/imgs/banner/brand-3.png') }}"
                            alt="">
                    </div>
                    <div class="brand-logo">
                        <img class="img-grey-hover" src="{{ asset('user/assets/imgs/banner/brand-4.png') }}"
                            alt="">
                    </div>
                    <div class="brand-logo">
                        <img class="img-grey-hover" src="{{ asset('user/assets/imgs/banner/brand-5.png') }}"
                            alt="">
                    </div>
                    <div class="brand-logo">
                        <img class="img-grey-hover" src="{{ asset('user/assets/imgs/banner/brand-6.png') }}"
                            alt="">
                    </div>
                    <div class="brand-logo">
                        <img class="img-grey-hover" src="{{ asset('user/assets/imgs/banner/brand-3.png') }}"
